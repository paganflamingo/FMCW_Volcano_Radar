...
#t = 0:t_clk/2:T                        
t = np.arange(0,T,t_clk)		# Create an array from 0 s to chirp period
...
S0 = chirp[1::2]			#From chirp, slice odd index by starting from index of 1
S1 = chirp[2::2]			#Slice even index, starting index of 2, since we have extra even index
